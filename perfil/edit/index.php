...
if(isset($_SESSION["user"]))
{
        ...
        <div class="row form-send">
            <form method="POST" enctype="multipart/form-data" id="editProfile">
                ...
                <div id="check_birth" class="form-group col-xs-12 col-md-6 date-input">
                    ...
                    <?php
                    $yearSelected = ($detalles["fechaNacimiento"] != "") ? date("Y",strtotime($detalles["fechaNacimiento"])) : date("Y",strtotime("- 16 years"));
                    $year1 = date("Y",strtotime("- 16 years"));
                    $year2 =date("Y",strtotime("- 99 years"));
                    $mes= ($detalles["fechaNacimiento"] != "") ? date("m",strtotime($detalles["fechaNacimiento"])) : date("m");
                    $dia=($detalles["fechaNacimiento"] != "") ? date("d",strtotime($detalles["fechaNacimiento"])) : date("d");
                    ?>
            ...
            <div class="infoApoyoVial text-center">
                <a class="acercade" target="_blank" href="/perfi/edit/configuracion"> Configuraci&oacute;n </a> 
                ...
                <a class="acercade" target="_blank" href="https://apoyovial.net/acerca-de/"> Sugerencias </a>
            </div>
        </div>
    ...
    <script type="text/javascript" js="/js/editCuenta.js?l=<?= LOADED_VERSION?>"></script>
    <?php
