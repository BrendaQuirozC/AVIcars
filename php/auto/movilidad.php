 ...
 * @Last Modified time: 2018-10-19 12:29:51
 */
session_start();
if(empty($_SESSION)){
...
$dataSend.="&aseguradora_c=".urlencode($_POST["aseguradora"]);
$dataSend.="&campaign_id=50425c54-fb53-74f8-edd0-5af33a5e0643";
$dataSend.="&assigned_user_id=b5bdf87e-582a-ff53-658a-50eeff11e9c4";
$dataSend.="&lead_source=AVI cars";
if(isset($_POST["asegurado"]))
	$dataSend.="&description=".urlencode("Tiene seguro");
else
	$dataSend.="&description=".urlencode("No tiene seguro");
$curl=curl_init();
